        ...
        <div className={`LevelCard l${levelImgSwitch(detailInfo && totalCount)}`}>
            ...
            <div className="other-info-wrap">
                <div className="other-info">
                    <div className="other-info-tit">&nbsp;생일</div>
                    {detailInfo ?
                ...
                <div className="other-info">
                    <div className="other-info-tit">&nbsp;메모</div>
                    {detailInfo && <div className="other-info-cont">{detailInfo && detailInfo?.detailInfo?.memo}</div>}
                </div>
            </div>
        </div>
    )
